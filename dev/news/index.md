...
- All preprocessing and QC functions now natively accept
  ...
  and
  [`glyexp::GlycoproteomicSE`](https://glycoverse.github.io/glyexp/reference/GlycoproteomicSE.html),
  preserve the input subclass, and continue to support
  [`glyexp::experiment()`](https://glycoverse.github.io/glyexp/reference/experiment.html)
  objects. (#19)
...
- Add `method` parameter to
  [`correct_batch_effect()`](https://glycoverse.github.io/glyclean/dev/reference/correct_batch_effect.md)
  supporting limma method for batch correction.

### Minor improvements and bug fixes

- Fix method handling in
  [`correct_batch_effect()`](https://glycoverse.github.io/glyclean/dev/reference/correct_batch_effect.md)
  for glyexp_experiment method.
