...
This outlines how to propose a change to glyclean. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("glycoverse/glyclean", fork = TRUE)`.
...
Please note that the glyclean project is released with a [Contributor
Code of
Conduct](https://glycoverse.github.io/glyclean/dev/CODE_OF_CONDUCT.md).
