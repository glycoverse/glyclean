...
Inspired by `mlr3pipelines`, **glyclean** uses a pipeline-based approach
to arrange data cleaning and preprocessing steps in a modular and flexible way,
so that different steps can be easily combined and customized, in any order.
